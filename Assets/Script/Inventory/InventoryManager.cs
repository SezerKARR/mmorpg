...
namespace Script.Inventory
{
    ...
    {
        [FormerlySerializedAs("_imageUnderCursor")] [SerializeField] private ImageUnderCursor imageUnderCursor;
        [FormerlySerializedAs("_equipmentManager")] [Inject] [SerializeField] private EquipmentManager equipmentManager;
        ...
        public void GroundClicked()
        {
            if (this._currentObjectController != null)
            {
                UIEvent.OnOpenConfirm?.Invoke($"{_currentObjectController.ObjectAbstract.DropName} eşyayı yere atmak istediğinden emin misiniz.",
                    DropObject,null);
            }
        }
        ...
        private void DropObject()
        {
            ...
            _objectPooler.ReturnObject(this._currentObjectController.ObjectAbstract.Type,this._currentObjectController.gameObject);
