        ...
        IEnumerator AnimateVertexColors()
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < lineCount; i++)
                {
                    ...
                    // Iterate through each characterType of the line.
                    for (int j = first; j <= last; j++)
                    {
                        ...
                        // Get the vertices of the mesh used by this text element (characterType or sprite).
                        ...
                        // Need to translate all 4 vertices of each quad to aligned with center of characterType.
                        ...
                        // Apply the scale change relative to the center of each characterType.
