...
public class CsvToSo
{
    ...
    private static string WariorHelmetCsvPath = "/CSVS/WarriorHelmet.csv";
     [MenuItem("Tools/Create Animator Controller")]
    public static void CreateAnimatorController()
    {
        // Oluşturulacak Animator Controller'ın adı ve yolu
        ...
        // Idle State için AnimationClip oluştur ve ata
        AnimationClip idleClip = CreateEmptyAnimationClip("Idle");
