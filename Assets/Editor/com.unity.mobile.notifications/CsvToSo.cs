...
// //         //             $"Assets/ScriptableObjects/Require/{upgradeItemsSO.itemName}.asset");
// //         //     }
// //         //
...
// //     
// //
//         [MenuItem("Utilities/HandleItem")]
//         private static void HandleItem()
//         {
//
//             string Item = "Assets/ScriptableObjects/Items";
//             string[] ItemGuids = AssetDatabase.FindAssets("t:ScriptableItemsAbstract", new[] { Item });
//             Debug.Log($"Found {Item.Length} upgrade item SOs");
//             List<ScriptableItemsAbstract> ItemSos = new List<ScriptableItemsAbstract>();
//             foreach (string upgradeItemsguid in ItemGuids)
//             {
//                 string upgradePath = AssetDatabase.GUIDToAssetPath(upgradeItemsguid);
//                 ItemSos.Add(AssetDatabase.LoadAssetAtPath<ScriptableItemsAbstract>(upgradePath));
//             }
//
//             foreach (var scriptableItemsAbstract in ItemSos)
//             {
//                 foreach (var requirement in scriptableItemsAbstract.requirements)
//                 {
//                     foreach (var upgradeItem in requirement.upgradeItems)
//                     {
//                         if (upgradeItem.upgradeItemName is UpgradeItemsSO upgradeItemsSo)
//                         {
//                             upgradeItem.upgradeItem = upgradeItemsSo;
//                             EditorUtility.SetDirty(upgradeItem.upgradeItem);
//                         }
//                             
//                         
//                     }
...
//          {
//
//              string upgradeItemsPath = "Assets/ScriptableObjects/Require";
...
// //                                 Require upgradeItem = new Require();
...
// //                             AssetDatabase.CreateAsset(upgradesItemSO, $"Assets/ScriptableObjects/Require/{upgradesItemSO.upgradeName}.asset");
// //                             
// //                         }
// //                     }
// //                     
...
// //                                 AssetDatabase.CreateAsset(upgradesItemSO, $"Assets/ScriptableObjects/Require/{upgradesItemSO.itemName}.asset");
// //
// //                             }
// //                         }
// //
...
// //             AssetDatabase.SaveAssets();
// //         }
// //         public static void AddObject(ref RequirementClass[] Requirements, Require upgradeItem, int swordPlus)
// //         {
...
// //                 Require(swordSO,splitData,upgradeItemRequire, upgradeMoney);
// //                 
// //                 i++;
// //             }
// //             else if (i == 7)
...
// //
// //     }
// //     public static void Require(SwordSO swordSO, string[] splitData, List<int> upgradeItemRequire, List<float> upgradeMoney)
// //     {
// //
// //         string upgradeItemsPath = "Assets/ScriptableObjects/Require";
// //         string[] upgradeItemsGuids = AssetDatabase.FindAssets("t:UpgradeItemsSO", new[] { upgradeItemsPath });
...
// //         // {
// //         //     string[] guids = AssetDatabase.FindAssets("t:ItemInstance", new[] { "Assets/ScriptableObjects/Items" });
// //         //
// //         //     foreach (var guid in guids)
// //         //     {
// //         //         // Her bir SO'yu yükle
// //         //         string path = AssetDatabase.GUIDToAssetPath(guid);
// //         //         ItemInstance itemStatsSO = AssetDatabase.LoadAssetAtPath<ItemInstance>(path);
// //         //
// //         //         if (itemStatsSO != null)
// //         //         {
...
// //         // {
// //         //     string[] guids = AssetDatabase.FindAssets("t:objectInstance", new[] { "Assets/ScriptableObjects" });
// //         //
// //         //     foreach (var guid in guids)
// //         //     {
// //         //         // Her bir SO'yu yükle
// //         //         string path = AssetDatabase.GUIDToAssetPath(guid);
// //         //         objectInstance itemStatsSO = AssetDatabase.LoadAssetAtPath<objectInstance>(path);
// //         //
// //         //         if (itemStatsSO != null)
// //         //         {
// //         //             itemStatsSO.SetDropName();
